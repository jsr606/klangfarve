...
void setup()
{
  ...
  Serial.begin(9600); // serial for RS485 control of leddar one sensor
    ...
    case 1:
      {
        ...
        //int p = analogRead(pot[0]);
        //mySerial.print("pot 0 "); mySerial.println(p);
        int p = 332;
        fadeSpeedMultiplier[0] = map_float(p, 0, 1023, 0.05, 1.5);
        //p = analogRead(pot[1]);
        //mySerial.print("pot 1 "); mySerial.println(p);
        p = 229;
        fadeSpeedMultiplier[1] = map_float(p, 0, 1023, 0.05, 1.5);
